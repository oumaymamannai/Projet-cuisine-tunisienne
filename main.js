...
document.addEventListener('DOMContentLoaded', () => {
  ...
  ['.dish-card', '.ing-card', '.testi-card', '.menu-item', '.res-detail', '.contact-item', '.faq-item'].forEach(sel => {
  ...
  console.log('%c✦ Mondélys', 'color: #B8895A; font-family: serif; font-size: 1.5rem; font-weight: bold;');
